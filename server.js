...
const earningRoutes = require("./backend/routes/earningRoutes");
const userRoutes = require("./backend/routes/userRoutes"); // Mount user routes
const guildRoutes = require("./backend/routes/guildRoutes"); // Mount guild routes
